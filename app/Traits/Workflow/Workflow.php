...
use App\Models\Workflow\WfMaster;
use App\Models\Workflow\WorkflowCandidate;
use App\Models\Workflow\WfRoleusermap;
use App\Models\Workflow\WfWardUser;
...
/**
 * Trait for Workflows
 * Modefied By-Sam kerketta
 * Modefied On-26-07-2023 
 * --------------------------------------------------------------------------------------
 */
...
trait Workflow
{
    ...
    /**
     * | Get the workflow master id using the ulbWorkflowId
     * | @param ulbWorkflowId
     */
    public function getWorkflowMstId($ulbWorkflowId)
    {
